...
const ERROR_MESSAGE = 'Error returned from [`validate()`](api.html#document_Document-validate) or `validateSync()`. Contains zero or more `ValidatorError` instances in `.errors` property.';
